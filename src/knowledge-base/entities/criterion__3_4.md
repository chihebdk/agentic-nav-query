...
# 3.4 Data Quality & Readiness

**Type:** Criterion  ·  **ID:** `criterion.3_4`

**Also known as:** 3.4, Data Quality & Readiness
...
- **dimension:** 3
- **criterion_id:** 3.4
- **anchors:** {'L1': 'Quality unmanaged; GIGO', 'L2': 'Quality checked ad-hoc', 'L3': 'Quality/freshness assured for priority sources; retrieval-ready', 'L4': 'Quality SLAs; low latency; structured/labeled at scale', 'L5': 'Continuous, automated quality + freshness; readiness by design'}

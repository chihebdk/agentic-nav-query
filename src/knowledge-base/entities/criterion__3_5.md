...
# 3.5 Retrieval & Context Engineering (RAG, grounding)

**Type:** Criterion  ·  **ID:** `criterion.3_5`

**Also known as:** 3.5, Retrieval & Context Engineering (RAG, grounding)
